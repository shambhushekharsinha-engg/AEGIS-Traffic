"""
AEGIS-Traffic — Enterprise Security Headers Middleware
Injects CSP, HSTS, X-Frame-Options, X-Content-Type-Options, X-XSS-Protection, and Referrer-Policy headers.
"""

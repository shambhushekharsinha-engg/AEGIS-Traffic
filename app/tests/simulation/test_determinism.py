...
def test_simulator_determinism():
    ...
    assert result_1 == result_2, "Simulator should produce identical output for identical input."
...
def test_queue_never_negative():
    ...
    assert result["projected"]["queue_length_m"] >= 0, "Queue length cannot be negative."
